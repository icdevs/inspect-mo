...
**⚠️ API Update Note**: The first example below demonstrates the **current ErasedValidator API** which is the recommended approach. Some subsequent examples may show older API patterns and will be updated in future revisions.
...
// Types module with accessor functions (generated by inspect-mo-generate)
module Types {
...
```motoko
import InspectMo "mo:inspect-mo";
import Permissions "mo:rbac-permissions";
import Types "types"; // Generated by inspect-mo-generate
import Principal "mo:core/Principal";
import Debug "mo:core/Debug";
